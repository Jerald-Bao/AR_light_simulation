...
public:
    ...
    PatternDetector
        (
        cv::Ptr<cv::Feature2D>     detector  = cv::SIFT::create(200,3,0.1,20,2,true), 
        ...
        cv::Ptr<cv::DescriptorMatcher>   matcher   = new cv::FlannBasedMatcher(new cv::flann::KDTreeIndexParams(3)),
